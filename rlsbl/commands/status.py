...
from ..changelog.validate import _is_autogenerated, _unreleased_range
        ...
        try:
            ...
            try:
                ...
                if result.returncode == 0:
                    ...
                    # Filter out autogenerated commits (same exemption as validate)
                    unreleased_commits = [
                    ...
                    if exempted > 0:
                        jsonl_coverage = (
                            ...
                            f" ({exempted} autogenerated exempted)"
                        )
                    else:

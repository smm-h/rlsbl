...
def _is_generated_router(filepath):
    """True when *filepath* carries the generated-router header.

    Distinguishes a router this tool wrote (safe to remove when it becomes
    obsolete) from a hand-authored root workflow (never touched).
    """
    try:

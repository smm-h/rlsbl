...
class Config:
    ...
    def with_coverage_unit(self, v: str) -> Config:
        return replace(self, coverage_unit=v)
...
def _bind_Config(v: Value) -> Config | None:
    ...
    f_coverage_unit = v.field("coverage_unit")
    return Config(
        ...
        coverage_unit=(f_coverage_unit[0].string()[0] if f_coverage_unit[1] else ""),
    )

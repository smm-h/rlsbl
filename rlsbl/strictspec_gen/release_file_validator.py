...
class ReleaseConfig:
    ...
    def with_unanchorable(self, v: bool) -> ReleaseConfig:
        return replace(self, unanchorable=v)
...
def _bind_ReleaseConfig(v: Value) -> ReleaseConfig | None:
    ...
    f_unanchorable = v.field("unanchorable")
    return ReleaseConfig(
        ...
        unanchorable=(f_unanchorable[0].bool()[0] if f_unanchorable[1] else False),
    )

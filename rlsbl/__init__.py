...
@release_group.command(
    name="retry",
    help="Dispatch CI/CD workflows for a completed release. Reads configuration from .rlsbl/releases/retry.toml (auto-scaffolded if missing). Verifies the GitHub Release exists, then dispatches each workflow via gh workflow run.",
    mutex=[
        strictcli.MutexGroup(flags=[

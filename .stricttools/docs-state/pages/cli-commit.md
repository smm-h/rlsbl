+++
title = "rlsbl commit"
description = "Commit one or more files with an Autogenerated trailer, marking the commit as machine-generated so it is automatically exempted from changelog coverage checks."
generated = true
seeded = true
...
| --- | --- | --- | --- | --- | --- |
| `--message` | `-m` | str | required |  | Commit message for the autogenerated-file commit (added with Autogenerated trailer) |

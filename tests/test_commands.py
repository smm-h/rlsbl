...
class TestReleaseCommitTrailers(unittest.TestCase):
    ...
    def test_version_bump_commit_not_autogenerated(self, _changes_dir, _extract, _finalize,
                                                    _validate, _gen_cl, _deploy, _tag,
                                                    _gh_inst, _gh_auth, _clean, _branch,
                                                    mock_commit_files, mock_run, _push,
                                                    _lock, _unlock):
        """The version-bump commit should NOT be marked autogenerated."""
        from rlsbl.commands.release import run_cmd
        ...
        # First call is the version-bump commit -- should NOT have autogenerated
        version_bump_call = mock_commit_files.call_args_list[0]
        self.assertIn("v1.0.1", version_bump_call[0][0])
        # autogenerated should not be passed or should be False (default)
        self.assertFalse(version_bump_call[1].get("autogenerated", False))
    ...
    def test_finalize_commit_is_autogenerated(self, _changes_dir, _extract, _finalize,
        ...
        self.assertTrue(finalize_call[1].get("autogenerated", False))
...
class TestStatusChangelogExemption(unittest.TestCase):
    ...
    def test_autogenerated_commits_exempted_from_coverage(self):
        ...
        self.assertIn("1 autogenerated exempted", data["jsonl_coverage"])

---
description: "Configuration reference for rlsbl: config.json with target selection and tagging across 14 registries, workspace.toml for monorepos, and selfdoc.json."
---

---
description: "Configuration reference for rlsbl: config.json settings (pipelines, launcher keys, batch limits, check_timeout, test block, and structured/freeform external_checks) and workspace.toml."
---

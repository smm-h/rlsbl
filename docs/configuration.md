---
description: "Configuration reference: config.json settings including pipelines, batch limits, check_timeout, test block, external_checks, and workspace.toml format."
---

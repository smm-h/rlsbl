---
description: "JSONL changelog reference: entry schema, adding entries, the 10 validation checks, caching, per-version markdown generation, and pre-push enforcement."
---

---
description: "JSONL changelog reference: entry schema, the format_version gate, adding entries, validation checks, caching, generation, and pre-push enforcement."
---

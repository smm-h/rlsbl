---
description: "JSONL changelog reference: entry schema, format_version gate, adding entries, validation checks, caching, markdown generation, and pre-push enforcement."
---

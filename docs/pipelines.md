---
description: "Pipeline architecture: types, auth patterns, custom assets, capability gating, Go artifact key, and the launcher artifact kind for wrapper-package publishing."
---
